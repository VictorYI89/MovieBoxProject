...
//	console.log('get movieName : ' + movieName);
//	console.log('get locationName : ' + locationName);
//	console.log('get roomName : ' + roomName);
//	console.log('get day : ' + day);
	
//	let div = document.querySelector(".info image");
	document.querySelector(".info").children[0].children[0].textContent=movieName; // 영화이름 변경
	document.querySelector(".info .area .main-area").children[0].textContent=locationName; // 지점명 변경
	document.querySelector(".info .area .main-area").children[1].textContent=roomName; // 상영관 변경
	document.querySelector(".info .area .main-area").children[2].textContent=day; // 날짜 변경
//	
	console.log('send to axios : ' + movieName);
//	axios.get('allMovieIdxMovieName.jsp?name='+movieName)
//	axios.get('selectMovieName.jsp?name='+movieName)
//	.then(response=>{
